...
protected:
    ...
    GLuint bufJointID; // A Vertex Buffer Object that we will use to store joint IDs
    GLuint bufJointWeight; // A Vertex Buffer Object that we will use to store joints' weights
...
public:
    ...
    void generateJointID();
    void generateJointWeight();
