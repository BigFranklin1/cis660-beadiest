...
void Camera::RecomputePolarAttributes()
{
    ...
    glm::mat4 polarM = glm::rotate(mat, glm::radians(theta), y_axis) *
            glm::rotate(mat, glm::radians(phi), x_axis) *
            glm::translate(mat, glm::vec3(0, 0, zoom));

    eye = glm::vec3(polarM * glm::vec4(0, 0, 0, 1));
    look = glm::vec3(polarM * glm::vec4(0, 0, 1, 0));
    up = glm::vec3(polarM * glm::vec4(0, 1, 0, 0));
    right = glm::vec3(polarM * glm::vec4(1, 0, 0, 0));
}
