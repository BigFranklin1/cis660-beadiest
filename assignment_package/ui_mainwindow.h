...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget_4->setGeometry(QRect(640, 490, 301, 31));
        horizontalLayout_4 = new QHBoxLayout(horizontalLayoutWidget_4);
        horizontalLayout_4->setSpacing(6);
        horizontalLayout_4->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_4->setObjectName(QString::fromUtf8("horizontalLayout_4"));
        horizontalLayout_4->setContentsMargins(0, 0, 0, 0);
        tri2hexaButton = new QPushButton(horizontalLayoutWidget_4);
        tri2hexaButton->setObjectName(QString::fromUtf8("tri2hexaButton"));

        horizontalLayout_4->addWidget(tri2hexaButton);

        MainWindow->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(MainWindow);
        menuBar->setObjectName(QString::fromUtf8("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 1310, 17));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tri2hexaButton->setText(QCoreApplication::translate("MainWindow", "Convert Triangle to Hexagon", nullptr));
